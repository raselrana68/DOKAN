...
@section('frontend_content')
	...
	<div class="page-info-section page-info">
		<div class="container">
			...
			<img src="{{ asset('frontendasset/img/page-info-art.png')}}" alt="" class="page-info-art">
		</div>
	</div>
	<!-- Page Info end -->
	...
	<div class="page-area product-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<figure>
					<img class="product-big-img" src="{{ asset('uploads/product_photos')}}/{{ $product_info->product_image }}" alt="">
					</figure>
					<div class="product-thumbs">
						<div class="product-thumbs-track">
							<div class="pt" data-imgbigurl="{{ asset('frontendasset/img/product/1.jpg')}}"><img src="{{ asset('frontendasset/img/product/thumb-1.jpg')}}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('frontendasset/img/product/2.jpg')}}"><img src="{{ asset('frontendasset/img/product/thumb-2.jpg')}}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('frontendasset/img/product/3.jpg')}}"><img src="{{ asset('frontendasset/img/product/thumb-3.jpg')}}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('frontendasset/img/product/4.jpg')}}"><img src="{{ asset('frontendasset/img/product/thumb-4.jpg')}}" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					...
					<div class="col-lg-10 offset-lg-1">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
								<span>{{ $product_info-> product_description}}</span>
							</div>
				...
				@foreach($related_products as $item)
					<div class="col-lg-3">
						...
						<figure>
							...
							<div class="pi-meta">
									<div class="pi-m-left">
										<img src="{{asset('frontendasset/img/icons/eye.png')}}" alt="">
										<p>quick view</p>
									</div>
									<div class="pi-m-right">
										<img src="{{asset('frontendasset/img/icons/heart.png')}}" alt="">
										<p>save</p>
									</div>
								</div>
							</figure>
							<div class="product-info">
								...
								<a href="{{url('product/details')}}/{{ $item->id}}" class="site-btn btn-line">Details</a>
							</div>
						</div>
					</div>
				@endforeach                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
