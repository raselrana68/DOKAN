...
<head>
	...
	<!-- Favicon -->   
	<link href="{{asset('frontendasset/img/favicon.ico')}}" rel="shortcut icon"/>
...
<body>
	...
	<header class="header-section">
		<div class="container-fluid">
			<!-- logo -->
			<div class="site-logo">
				<img src="{{asset('frontendasset/img/logo.png')}}" alt="logo">
			</div>
			<!-- responsive -->
			...
			<div class="header-right">
				<a href="cart.html" class="card-bag"><img src="{{asset('frontendasset/img/icons/bag.png')}}" alt=""><span>2</span></a>
				<a href="#" class="search"><img src="{{asset('frontendasset/img/icons/search.png')}}" alt=""></a>
			</div>
			<!-- site menu -->
			<ul class="main-menu">
				...
				@foreach ($products as $item)
					<li>
						<div class="intro-item">
							<figure>
								<a href="{{url('/')}}"><img src="{{ asset('uploads/product_photos')}}/{{$item->product_image }}" alt="">
								</a>
							</figure>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="{{asset('frontendasset/js/jquery-3.2.1.min.js')}}"></script>
	<script src="{{asset('frontendasset/js/owl.carousel.min.js')}}"></script>
	<script src="{{asset('frontendasset/js/mixitup.min.js')}}"></script>
	<script src="{{asset('frontendasset/js/sly.min.js')}}"></script>
	<script src="{{asset('frontendasset/js/jquery.nicescroll.min.js')}}"></script>
